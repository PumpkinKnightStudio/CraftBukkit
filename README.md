...
* In your new buildtools/ directory, you should have a work/ directory.
* run (from your craftbukkit directory) ./applypatches /path/to/buildtools/work/decompile-xxx
* that will apply patches and give you updated CraftBukkit build
