    ...
    public void handlePlayerCommand(PacketPlayInEntityAction packetplayinentityaction) {
        ...
        switch (packetplayinentityaction.getAction()) {
            ...
            case RELEASE_SHIFT_KEY:
                ...
                break;
            case START_SPRINTING:
                this.player.setAllowStrongKnockBack(true); // CraftBukkit - Enable player strong knock back
                this.player.setSprinting(true);
                break;
            case STOP_SPRINTING:
                this.player.setAllowStrongKnockBack(false); // CraftBukkit - Disable player strong knock back
