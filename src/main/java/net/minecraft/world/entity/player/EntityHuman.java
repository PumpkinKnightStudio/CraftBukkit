...
public abstract class EntityHuman extends EntityLiving {
    ...
    public boolean allowStrongKnockBack = true;
        ...
        if (entity.isAttackable()) {
            if (!entity.skipAttackInteraction(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    // CraftBukkit start
                    if (this.isDamageSourceBlocked(this.damageSources().playerAttack(this))) {
                        i = 0;
                    }
                    // CraftBukkit end
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            this.setAllowStrongKnockBack(false); // CraftBukkit - Disable strong knockback
                        }
    ...
    // CraftBukkit start - Spigot-7364
    public boolean isAllowStrongKnockBack() {
        return this.allowStrongKnockBack;
    }

    public void setAllowStrongKnockBack(boolean allowStrongKnockBack) {
        this.allowStrongKnockBack = allowStrongKnockBack;
    }
}
