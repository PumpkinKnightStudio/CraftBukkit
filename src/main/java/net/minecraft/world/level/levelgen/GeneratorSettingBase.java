...
public final class GeneratorSettingBase {
    ...
    public GeneratorSettingBase(StructureSettings structuresettings, NoiseSettings noisesettings, IBlockData iblockdata, IBlockData iblockdata1, SurfaceRules.o surfacerules_o, int i, boolean flag, boolean flag1, boolean flag2, boolean flag3, boolean flag4, boolean flag5) {
