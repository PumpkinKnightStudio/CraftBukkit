...
public class CraftAttributeMap implements Attributable {
    ...
    public AttributeInstance getAttribute(Attribute attribute) {
        ...
        net.minecraft.world.entity.ai.attributes.AttributeModifiable nms = handle.getInstance(toMinecraft(CraftRegistry.getMinecraftRegistry().registryOrThrow(Registries.ATTRIBUTE), attribute));
