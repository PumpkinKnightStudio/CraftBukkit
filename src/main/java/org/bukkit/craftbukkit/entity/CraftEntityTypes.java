...
public final class CraftEntityTypes {
    ...
    public record EntityTypeData<E extends Entity, M extends net.minecraft.world.entity.Entity>(EntityType<E> entityType,
                                                                                                Class<E> entityClass,
    ...
    static {
        ...
        register(new EntityTypeData<>(EntityType.POTION, ThrownPotion.class, CraftThrownPotion::new, spawnData -> {
            ...
            entity.setItem(CraftItemStack.asNMSCopy(ItemStack.of(ItemType.SPLASH_POTION, 1)));
            return entity;
        }));
