...
public class CustomChunkGenerator extends InternalChunkGenerator {
    ...
    public void buildBase(RegionLimitedWorldAccess regionlimitedworldaccess, IChunkAccess ichunkaccess) {
        ...
        if (generator.shouldGenerateSurface()) {
            // Update the relevant height maps, otherwise IChunkAccess#getHighestBlock sometimes returns zeros for entire chunks.
            HeightMap.a(ichunkaccess, ichunkaccess.getChunkStatus().h());
